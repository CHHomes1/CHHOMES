...
const style = {
  featured:
    "bg-[#090333] mt-24 p-12 bg-opacity-[1] w-[100vw] overflow-x-hidden",
  container: "flex flex-col md:flex-row justify-around",
  heading:
    "my-2 text-blue-200 text-3xl sm:text-3xl md:text-2xl lg:text-3xl my-6 mx-auto",
  moreButtonContainer: "",
  moreButton:
    "text-white hover:scale-[0.95] transition duration-[300ms] bg-blue-700 max-w-fit px-3 md:px-12 lg:px-18 py-2 md:py-3 lg:py-4 mx-auto mt-12 md:mt-12",
};
