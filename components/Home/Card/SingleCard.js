...
const style = {
  ...
  icon: "mx-auto text-4xl md:text-5xl text-orange-400 ",
  heading:
    "my-4 text-orange-400 text-center text-2xl sm:text-lg md:text-3xl lg:text-4xl",
  details:
    "text-stone-800 text-center text-md sm:text-sm md:text-lg lg:text-md",
};
