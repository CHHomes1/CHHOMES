...
const style = {
  ...
  smallHeading:
    "text-center md:text-left my-2 text-orange-400 text-md sm:text-sm md:text-lg lg:text-xl mx-auto md:mx-0 tracking-widest",
  contentHeading:
    "text-center md:text-left my-2 text-stone-700 text-3xl sm:text-3xl md:text-4xl lg:text-4xl my-6 md:my-8 mx-auto",
};
